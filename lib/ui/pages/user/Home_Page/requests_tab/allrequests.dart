...
class AllRequestsPageModel extends BaseNotifier {
  final HttpApi api;
  final AuthenticationService auth;
  final BuildContext context;
  RefreshController _refreshController = RefreshController();

  AllRequestsPageModel({
    NotifierState state,
    this.api,
    this.auth,
    this.context,
