...
Widget getreq(
  PendingRequestsPageModel model,
  int index,
  context,
  allreq,
) {
...
class PendingRequestsPageModel extends BaseNotifier {
  final HttpApi api;
  final AuthenticationService auth;
  final BuildContext context;
  RefreshController _refreshController = RefreshController();

  PendingRequestsPageModel({
    NotifierState state,
    this.api,
    this.auth,
    this.context,
  ...
  getAllrequests() async {
    ...
    print("=========================grhtjyfhgfhfgjhfjfhjfhjhfjf=");
    print(param);
